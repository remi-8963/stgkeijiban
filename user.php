...
<html>
    <head>
        ...
        <meta property="og:image" content="https://cs-tklab2.na-inet.jp/~tklab2021/091/stgkeijiban/profile_images/<?=$id?>.png"><!-- 対象用の画像URL -->
        <meta property="og:url" content="https://cs-tklab2.na-inet.jp/~tklab2021/091/stgkeijiban"><!-- ページのURL -->
        ...
        <?php  $result_users_games = mysqli_query($db,$sql_users_games) or die(mysqli_error($db));
            ...
            <ul>
                ...
                <?php endif ?>
                    ...
                    <li><a href="https://twitter.com/intent/tweet?url=https://cs-tklab2.na-inet.jp/~tklab2021/091/stgkeijiban/user.php?id=<?=h($id)?>&text=<?=h($name)?>さんのプロフィールをみにいこう！"><button>共有</button></a></li>
            </ul>
